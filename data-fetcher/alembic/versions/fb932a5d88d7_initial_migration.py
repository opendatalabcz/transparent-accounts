...
Revision ID: fb932a5d88d7
Revises: 
Create Date: 2022-12-29 10:46:50.097104
...
def upgrade() -> None:
    ...
    sa.Column('bank_code', sa.String(length=4), sa.CheckConstraint('LENGTH(bank_code) = 4'), nullable=False),
